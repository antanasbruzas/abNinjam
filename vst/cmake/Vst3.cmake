...
function(plugin_add_vst3sdk NAME)
    target_sources("${NAME}" PRIVATE
        ...
        # undefined symbol: _ZN9Steinberg10SystemTime10getTicks64Ev
...
function(plugin_add_vstgui NAME)
    ...
    elseif(APPLE)
        ...
        if(${CMAKE_BUILD_TYPE} MATCHES "Debug")
            message(STATUS "DEFAULT_CMAKE_FIND_LIBRARY_SUFFIXES: " ${DEFAULT_CMAKE_FIND_LIBRARY_SUFFIXES})
        endif()
        ...
        if (USE_STATIC_DEPENDENCIES)
            ...
            if(${CMAKE_BUILD_TYPE} MATCHES "Debug")
                message(STATUS "STATIC_CMAKE_FIND_LIBRARY_SUFFIXES: " ${STATIC_CMAKE_FIND_LIBRARY_SUFFIXES})
                message(STATUS "CMAKE_FIND_LIBRARY_SUFFIXES: " ${CMAKE_FIND_LIBRARY_SUFFIXES})
            endif()
        endif()
        find_package(XCB COMPONENTS UTIL CURSOR KEYSYMS XKB IMAGE RENDERUTIL REQUIRED)
...
#        endif()
    ...
    target_sources("${NAME}" PRIVATE
        "${VST3SDK_BASEDIR}/vstgui4/vstgui/plugin-bindings/vst3groupcontroller.cpp"
        "${VST3SDK_BASEDIR}/vstgui4/vstgui/plugin-bindings/vst3padcontroller.cpp"
        "${VST3SDK_BASEDIR}/vstgui4/vstgui/plugin-bindings/vst3editor.cpp"
        "${VST3SDK_BASEDIR}/vstgui4/vstgui/vstgui_uidescription.cpp"
