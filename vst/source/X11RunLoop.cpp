...
struct RunLoop::EventHandler final : Steinberg::Linux::IEventHandler,
...
struct RunLoop::TimerHandler final : Steinberg::Linux::ITimerHandler,
                                     public Steinberg::FObject {
...
bool RunLoop::registerEventHandler(int fd, X11::IEventHandler *handler) {
  ...
  if (runLoop->registerEventHandler(smtgHandler, fd) ==
